...
public sealed class FiringTableTests
{
    private static FiringTable LoadL81()
    {
        ...
        [
            ...
            Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "..", "src", "WardogsMortar.Core", "Data", "l81-apollyon.json"),
            "/src/WardogsMortar.Core/Data/l81-apollyon.json",
            "src/WardogsMortar.Core/Data/l81-apollyon.json",
        ];
        ...
        {
            var f = Path.Combine(dir.FullName, "src", "WardogsMortar.Core", "Data", "l81-apollyon.json");
            if (File.Exists(f))
            {
