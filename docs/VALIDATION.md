...
- Data: Apollyon L81 (132–684 m, coverage 80–697 m), linear interpolation, no extrapolation, uncorrected table. See src/WardogsMortar.Core/Data/PROVENANCE.md.
...
- Packaged Windows: `scripts/publish.ps1` → out/WardogsMortarAssist-win-x64 + .zip (72 MB). Published exe runs from C:/, self-test and diagnose A pass. Build 0 errors.
